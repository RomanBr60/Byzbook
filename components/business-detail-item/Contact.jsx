  ...
  return (
   ...
   {     (data?.gsx$email || data?.gsx$whatsapp || data?.gsx$phone) && 
    ...
    <div className="row align-items-center gap-2 ">
      ...
      {data?.gsx$email && (
        <label onClick={()=>{window.location.href = `mailto:${data?.gsx$email}`}} className=" radius2 cursor col-sm bg-light radius2 d-flex align-items-center text-black shadow ls5 p-2 fs_12">
          {data?.gsx$email}
        </label>
      )}
                </div>
