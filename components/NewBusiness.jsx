      ...
      <div className="container p-2 mb-5">
        <div className="row listRow1">
          {!editable ? (
            ...
            <TypeSelect handleInputChange={handleInputChange} types={types}/>

               <ImageUpload handleFileChange={handleFileChange}/>

               <CitySelect changeVal={changeVal} handleInputChange={handleInputChange} notEmptyVal={notEmptyVal}/>
                {/* Phone Contact Section ----------------- */}
              <PhoneContactSection contactForm={contactForm} handleInputChange={handleInputChange}/>
                {/* ---------------------------- */}
              <LinksSection handleInputChange={handleInputChange} linksForm={linksForm}/>

                {/* ----------------------------------------- */}
             <CommentsField commentForm={commentForm} handleInputChange={handleInputChange}/>
                {/* -------------------------- */}
                <label className="label1 text-white bgc8 radius2 p-1">
                  {workHoursForm.title}
                </label>
          <WorkHours handleInputChange={handleInputChange} workHoursForm={workHoursForm}/>
