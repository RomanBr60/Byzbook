...
export default function BusinessPageEditor(props) {
  ...
  const types = props.types.sort((a, b) =>
    a.gsx$type.localeCompare(b.gsx$type)
  );
  ...
  const changeArray = (val, key, idx) => {
    var obj = Object.assign({}, localData);
    let insertedVal = whetherEmpty(val);
    obj[key] = obj[key].map((value, index) =>
      index === idx ? insertedVal : value
    );
    setLocalData(obj);
    checkValues(obj);
  };
  ...
  const submitByzData = async (e) => {
    ...
    await fetchData(`${apiRouteList.business}businessUpdate`, "put", { data: localData })
      .then((data) => {
        alert("העסק עודכן");
            ...
            <div className="typeEditor col-lg-6 col-md-6 col-lg-offset-3 col-md-offset-3">
              <div className="panel panel-info">
                <div className="panel-heading">
                  <h1 className="caption title panel-title text-center">
                    {defaultData.gsx$name}
                  </h1>
                </div>
                  ...
                  <form onSubmit={(e) => handleSubmit(e)}>
                      ...
                      <div className="form-group form-group-sm">
                        <div className="longItem col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          ...
                          <select
                            ...
                            style={{ direction: "rtl" }}
                            onChange={(e) =>
                              changeVal(types[e.target.value]._id, "gsx$type")
                            }
                            value={findIndexOfTypeById(notEmptyVal("gsx$type"))}
                          >
                            {types.map((e, j) => {
                              return (
                                <option key={e.gsx$type} value={j}>
                                  {j + 1 + ". " + e.gsx$type}
                                </option>
                              );
                            })}
                        ...
                        <div className="longItem col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          ...
                          <div className="input-group-sm">
                            <input
                              ...
                              className="form-control"
                              placeholder="שם עסק"
                              value={notEmptyVal("gsx$name")}
                              onChange={(e) =>
                                changeVal(e.target.value, "gsx$name")
                              }
                              style={{ direction: "rtl" }}
                              required
                            />
                    ...
                    >
                      <span className="input-group-addon">
                        <span className="fa fa-fw fa-file-image-o"></span>
                      </span>
                      ...
                      <input
                        ...
                        value={notEmptyVal("gsx$logo")}
                        onChange={(e) => changeVal(e.target.value, "gsx$logo")}
                        ...
                        <div className="longItem col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          ...
                          >
                            <input
                              ...
                              max="500"
                              className="form-control"
                              placeholder="אורך לוגו"
                              required
                              value={notEmptyVal("gsx$logowidth")}
                              onChange={(e) =>
                                changeVal(e.target.value, "gsx$logowidth")
                              }
                              style={{ direction: "ltr" }}
                            />
                        ...
                        <div className="longItem col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          ...
                          >
                            <input
                              ...
                              required
                              value={notEmptyVal("gsx$logoheight")}
                              onChange={(e) =>
                                changeVal(e.target.value, "gsx$logoheight")
                              }
                              style={{ direction: "ltr" }}
                            />
                        ...
                        <div className="longItem col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          ...
                          <div className="input-group-sm">
                            <input
                              ...
                              className="form-control"
                              placeholder="כתובת"
                              value={notEmptyVal("gsx$address")}
                              onChange={(e) =>
                                changeVal(e.target.value, "gsx$address")
                              }
                              style={{ direction: "rtl" }}
                            />
                          </div>
                        ...
                        <div className="longItem col-lg-6 col-md-6 col-sm-6 col-xs-6 formInput">
                          ...
                          >
                            ...
                            <input
                              ...
                              placeholder="טלפון2"
                              max="11"
                              value={notEmptyVal("gsx$phone", 1)}
                              onChange={(e) =>
                                changeArray(e.target.value, "gsx$phone", 1)
                              }
                              style={{ direction: "ltr", textAlign: "left" }}
                            />
                          </div>
                        ...
                        <div className="longItem col-lg-6 col-md-6 col-sm-6 col-xs-6 formInput">
                          ...
                          >
                            ...
                            <input
                              ...
                              maxLength="11"
                              required
                              value={notEmptyVal("gsx$phone", 0)}
                              onChange={(e) =>
                                changeArray(e.target.value, "gsx$phone", 0)
                              }
                              style={{ direction: "ltr", textAlign: "left" }}
                            />
                          </div>
                        ...
                        <div className="longItem col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          ...
                          >
                            ...
                            <input
                              ...
                              placeholder="ווטסאפ"
                              maxLength="11"
                              value={notEmptyVal("gsx$whatsapp")}
                              onChange={(e) =>
                                changeVal(e.target.value, "gsx$whatsapp")
                              }
                              style={{ direction: "ltr", textAlign: "left" }}
                            />
                          </div>
                        ...
                        <div className="longItem col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          ...
                          >
                            ...
                            <input
                              ...
                              placeholder="טלפון3"
                              maxLength="11"
                              value={notEmptyVal("gsx$phone", 2)}
                              onChange={(e) =>
                                changeArray(e.target.value, "gsx$phone", 2)
                              }
                              style={{ direction: "ltr", textAlign: "left" }}
                            />
                          </div>
                    ...
                    >
                      ...
                      <input
                        ...
                        className="form-control"
                        placeholder="אימייל"
                        value={notEmptyVal("gsx$email")}
                        onChange={(e) => changeVal(e.target.value, "gsx$email")}
                        style={{ direction: "ltr", textAlign: "left" }}
                      />
                    </div>
                    ...
                    >
                      ...
                      <input
                        ...
                        value={notEmptyVal("gsx$facebook")}
                        onChange={(e) =>
                          changeVal(e.target.value, "gsx$facebook")
                        }
                        style={{ direction: "ltr", textAlign: "left" }}
                      />
                    </div>
                    ...
                    >
                      ...
                      <input
                        ...
                        value={notEmptyVal("gsx$instagram")}
                        onChange={(e) =>
                          changeVal(e.target.value, "gsx$instagram")
                        }
                        style={{ direction: "ltr", textAlign: "left" }}
                      />
                    </div>
                    ...
                    >
                      ...
                      <input
                        ...
                        value={notEmptyVal("gsx$website")}
                        onChange={(e) =>
                          changeVal(e.target.value, "gsx$website")
                        }
                        style={{ direction: "ltr", textAlign: "left" }}
                      />
                    </div>
                    ...
                    >
                      <input
                        ...
                        className="form-control"
                        placeholder="הערות"
                        value={notEmptyVal("gsx$comment")}
                        onChange={(e) =>
                          changeVal(e.target.value, "gsx$comment")
                        }
                        style={{ direction: "rtl" }}
                      />
                      <span className="input-group-addon">
                        <span className="fa fa-fw fa fa-comment"></span>
                      </span>
                    </div>
                      ...
                      {[0, 1, 2].map((e1, i) => (
                        ...
                        >
                          <input
                            ...
                            value={notEmptyVal("gsx$worktime", i)}
                            onChange={(e2) =>
                              changeArray(e2.target.value, "gsx$worktime", i)
                            }
                            style={{ direction: "rtl" }}
                          />
                          <span className="input-group-addon">
                            <span className="fa fa-fw fa-clock-o"></span>
                          </span>
                        </div>
                      ))}
                    </div>
                    ...
                    <div
                      className="formInput form-group"
                      style={{ marginTop: "-2%" }}
                    >
                      ...
                      <textarea
                        ...
                        style={{ resize: "unset" }}
                        value={notEmptyVal("gsx$desc")}
                        onChange={(e) => changeVal(e.target.value, "gsx$desc")}
                      ></textarea>
                    </div>
                    ...
                    <div style={{ marginTop: "4%" }}>
                      ...
                      <button
                        type="submit"
                        className="btn btn-warning btn-md pull-left"
                        disabled={!changed}
                        onClick={(e) => setFun(0)}
                      >
                        שמירה
                      ...
                      {1 == 2 && (
                        <button
                          ...
                          onClick={(e) =>
                            changeVal(!localData.gsx$active, "gsx$active")
                          }
                          style={{ marginTop: "2%" }}
                        >
                          {localData.gsx$active ? "להשבית" : "להפעיל"}
                        </button>
                      )}

                      {1 == 1 && (
                        <CheckBox
                          value={localData.gsx$active}
                          dataOn="מופעל"
                          dataOff="מושבת"
                          onChange={(e) => {
                            changeVal(!localData.gsx$active, "gsx$active");
